...
const ProductDescription = () => {
    ...
    <View style={{position: 'relative', marginTop : 8}}>
        ...
        <View style={styles.productDetailHeader}>
            <Text style={styles.productName}>Bell Pepper Nutella karmen lopu 
            Karmen mon</Text>
    ...
    <View style={styles.offerBox}>
      ...
      <View style={styles.QuantityTextContainer}>
        ...
        <Text style={styles.descriptionText}>Nutella® is famous for its authentic taste of hazelnuts and cocoa, made even more irresistible by its unique creaminess.</Text>
